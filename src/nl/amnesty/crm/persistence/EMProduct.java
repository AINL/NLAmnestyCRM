...
import nl.amnesty.crm.sql.ProductSQL;
 ...
 * @version 1.00
 */
public class EMProduct implements EntityManager {
    ...
    public <T> T persist(T t) {
        ...
        try {
            ...
            return (T) productsql.create(connection, (Product) t);
        } catch (Exception e) {
            Logger.getLogger(EMProduct.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    public <T> T find(long id) {
        ...
        try {
            ...
            connection = database.open();
            ProductSQL productsql = new ProductSQL();
            return (T) productsql.read(connection, id);
        } catch (Exception e) {
            Logger.getLogger(EMProduct.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    public <T> boolean merge(T t) {
        ...
        try {
            ...
            connection = database.open();
            ProductSQL productsql = new ProductSQL();
            return productsql.update(connection, (Product) t);
        } catch (Exception e) {
            Logger.getLogger(EMProduct.class.getName()).log(Level.SEVERE, null, e);
            return false;
        } finally {
    ...
    public <T> boolean remove(long id) {
        ...
        try {
            ...
            connection = database.open();
            ProductSQL productsql = new ProductSQL();
            return productsql.delete(connection, id);
        } catch (Exception e) {
            Logger.getLogger(EMProduct.class.getName()).log(Level.SEVERE, null, e);
            return false;
        } finally {
    ...
    public <T> T match(T t) {
        ...
        try {
            ...
            connection = database.open();
            ProductSQL productsql = new ProductSQL();
            return (T) productsql.match(connection, (Product) t);
        } catch (Exception e) {
            Logger.getLogger(EMProduct.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
     ...
     * @return      Product that matches the name, if any
     * @exception   Database error has occured
     */
    public Product productReadViaName(String name) {
        Database database = null;
        Connection connection = null;
        try {
            database = new Database(Database.DB_CRM_JNDI_NAME);
            connection = database.open();
            ProductSQL productsql = new ProductSQL();
            return productsql.readViaName(connection, name);
        } catch (Exception e) {
            Logger.getLogger(EMProduct.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    private static void closeSQL(Database database, Connection connection) {
        try {
            ...
            Logger.getLogger(EMProduct.class.getName()).log(Level.SEVERE, null, sqle);
        }
    }
