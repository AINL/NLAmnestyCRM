...
import nl.amnesty.crm.sql.FinanceSQL;
 ...
 * @version 1.00
 */
public class EMFinance implements EntityManager {
    ...
    public <T> T persist(T t) {
        ...
        try {
            ...
            FinanceSQL financesql = new FinanceSQL();
            return (T) financesql.create(connection, (Finance) t);
        } catch (Exception e) {
            Logger.getLogger(EMFinance.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    public <T> T find(long id) {
        ...
        try {
            ...
            connection = database.open();
            FinanceSQL financesql = new FinanceSQL();
            return (T) financesql.read(connection, id);
        } catch (Exception e) {
            Logger.getLogger(EMFinance.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    public <T> boolean merge(T t) {
        ...
        try {
            ...
            connection = database.open();
            FinanceSQL financesql = new FinanceSQL();
            return financesql.update(connection, (Finance) t);
        } catch (Exception e) {
            Logger.getLogger(EMFinance.class.getName()).log(Level.SEVERE, null, e);
            return false;
        } finally {
    ...
    public <T> boolean remove(long id) {
        ...
        try {
            ...
            connection = database.open();
            FinanceSQL financesql = new FinanceSQL();
            return financesql.delete(connection, id);
        } catch (Exception e) {
            Logger.getLogger(EMFinance.class.getName()).log(Level.SEVERE, null, e);
            return false;
        } finally {
    ...
    public <T> T match(T t) {
        ...
        try {
            ...
            connection = database.open();
            FinanceSQL financesql = new FinanceSQL();
            return (T) financesql.match(connection, (Finance) t);
        } catch (Exception e) {
            Logger.getLogger(EMFinance.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    private static void closeSQL(Database database, Connection connection) {
        try {
            ...
            Logger.getLogger(EMFinance.class.getName()).log(Level.SEVERE, null, sqle);
        }
    }
