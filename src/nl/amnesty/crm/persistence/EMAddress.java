...
import nl.amnesty.crm.sql.AddressSQL;
 ...
 * @version 1.00
 */
public class EMAddress implements EntityManager {
    ...
    public <T> T persist(T t) {
        ...
        try {
            ...
            return (T) addresssql.create(connection, (Address) t);
        } catch (Exception e) {
            Logger.getLogger(EMAddress.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    public <T> T find(long id) {
        ...
        try {
            ...
            connection = database.open();
            AddressSQL addresssql = new AddressSQL();
            return (T) addresssql.read(connection, id);
        } catch (Exception e) {
            Logger.getLogger(EMAddress.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    public <T> boolean merge(T t) {
        ...
        try {
            ...
            connection = database.open();
            AddressSQL addresssql = new AddressSQL();
            return addresssql.update(connection, (Address) t);
        } catch (Exception e) {
            Logger.getLogger(EMAddress.class.getName()).log(Level.SEVERE, null, e);
            return false;
        } finally {
    ...
    public <T> boolean remove(long id) {
        ...
        try {
            ...
            connection = database.open();
            AddressSQL addresssql = new AddressSQL();
            return addresssql.delete(connection, id);
        } catch (Exception e) {
            Logger.getLogger(EMAddress.class.getName()).log(Level.SEVERE, null, e);
            return false;
        } finally {
    ...
    public <T> T match(T t) {
        ...
        try {
            ...
            connection = database.open();
            AddressSQL addresssql = new AddressSQL();
            return (T) addresssql.match(connection, (Address) t);
        } catch (Exception e) {
            Logger.getLogger(EMAddress.class.getName()).log(Level.SEVERE, null, e);
            return null;
        } finally {
    ...
    private static void closeSQL(Database database, Connection connection) {
        try {
            ...
            Logger.getLogger(EMAddress.class.getName()).log(Level.SEVERE, null, sqle);
        }
    }
